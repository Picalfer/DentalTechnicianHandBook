...
class SeparateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when(intent.getStringExtra("content")) {
            getString(R.string.veneers_classic) -> setContent(R.drawable.ven, R.string.veneers_classic)
            getString(R.string.acrylic_bridge) -> setContent(R.drawable.acrylic_bridge, R.string.content_logo_acrylic_bridge)
            ...
            getString(R.string.cast_crown) -> setContent(R.drawable.cast_crown, R.string.cast_crown)
            getString(R.string.acrylic_crown) -> setContent(R.drawable.acrylic_crown, R.string.acrylic_crown)
            getString(R.string.met_cer_crown) -> setContent(R.drawable.met_cer_crown, R.string.met_cer_crown)
    ...
    private fun setContent(imContent: Int, logo: Int) {
